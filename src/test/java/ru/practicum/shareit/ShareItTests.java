...
class ShareItTests {
    ...
    public void testCreateAndGetUserById() {
        userService.createUser(new UserDto(null, "FirstUser", "FirstEmail"));
        userService.createUser(new UserDto(null, "SecondUser", "SecondEmail"));
        assertThat(userService.getUserById(1).getName()).isEqualTo("SecondUser");
    }

    @Test
    public void testCreateAndGetUserByIdNegative() {
        userService.createUser(new UserDto(null, "FirstUser", "AnotherFirstEmail"));
        userService.createUser(new UserDto(null, "SecondUser", "AnotherSecondEmail"));
    ...
    public void testCreateItemAndGetHim() {
        userService.createUser(new UserDto(null, "FirstUser", "OtherFirstEmail"));
        userService.createUser(new UserDto(null, "SecondUser", "OtherSecondEmail"));
